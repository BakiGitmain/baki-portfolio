...
const sensitiveAdminLimiter = rateLimit({
    ...
    message: {
        success: false,
        message: "Too many account update attempts. Try again later.",
    },
});
/* =========================================================
   VALIDATION
...
/* =========================================================
   UPDATE ACCOUNT
   ========================================================= */
router.patch("/account", requireAdmin, sensitiveAdminLimiter, async (req, res) => {
    ...
    /* =====================================================
       ...
       ===================================================== */
    const passwordMatches = await bcrypt.compare(currentPassword, currentAdmin.password_hash);
    if (!passwordMatches) {
        res.status(401).json({
            success: false,
